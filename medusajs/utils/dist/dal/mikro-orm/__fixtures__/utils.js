...
exports.SearchableEntity2 = exports.SearchableEntity1 = exports.RecursiveEntity2 = exports.RecursiveEntity1 = exports.ProductVariant = exports.ProductOptionValue = exports.ProductOption = exports.Product = exports.InternalCircularDependencyEntity1 = exports.Entity2WithUnDecoratedProp = exports.Entity2 = exports.Entity1WithUnDecoratedProp = exports.Entity1 = exports.DeepRecursiveEntity4 = exports.DeepRecursiveEntity3 = exports.DeepRecursiveEntity2 = exports.DeepRecursiveEntity1 = void 0;
...
__decorate([
    (0, core_1.OneToMany)(() => ProductOption, (o) => o.product, {
        cascade: ["soft-remove"],
    }),
    __metadata("design:type", Object)
], Product.prototype, "options", void 0);
__decorate([
    (0, core_1.OneToMany)(() => ProductVariant, (variant) => variant.product, {
        cascade: ["soft-remove"],
    }),
    __metadata("design:type", Object)
...
__decorate([
    (0, core_1.OneToMany)(() => ProductOptionValue, (value) => value.option, {
...
__decorate([
    (0, core_1.ManyToOne)(() => ProductOption, {
        columnType: "text",
        fieldName: "option_id",
        mapToPk: true,
        nullable: true,
...
__decorate([
    (0, core_1.ManyToMany)(() => ProductVariant, (variant) => variant.options),
    __metadata("design:type", Object)
...
__decorate([
    (0, core_1.ManyToMany)(() => ProductOptionValue, "variants", {
        owner: true,
...
let DeepRecursiveEntity1 = class DeepRecursiveEntity1 {
    constructor(props) {
        this.entity3 = new core_1.Collection(this);
        this.entity2 = new core_1.Collection(this);
        this.id = props.id;
        this.deleted_at = props.deleted_at;
    }
...
__decorate([
    (0, core_1.OneToMany)(() => DeepRecursiveEntity3, (entity3) => entity3.entity1, {
        cascade: ["soft-remove"],
    }),
    __metadata("design:type", Object)
], DeepRecursiveEntity1.prototype, "entity3", void 0);
__decorate([
