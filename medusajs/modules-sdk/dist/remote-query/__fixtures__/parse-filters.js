...
const customModuleJoinerConfig = (0, utils_1.defineJoinerConfig)("custom_user", {
    schema: `
    type CustomProduct {
      id: ID
      title: String
...
const productJoinerConfig = (0, utils_1.defineJoinerConfig)("product", {
    schema: `
    type Product {
      id: ID
      title: String
...
const pricingJoinerConfig = (0, utils_1.defineJoinerConfig)("pricing", {
    schema: `
    type PriceSet {
      id: ID
      prices: [Price]
...
medusa_module_1.MedusaModule.setJoinerConfig("product", productJoinerConfig);
medusa_module_1.MedusaModule.setJoinerConfig("pricing", pricingJoinerConfig);
medusa_module_1.MedusaModule.setJoinerConfig("customProduct", customModuleJoinerConfig);
medusa_module_1.MedusaModule.setJoinerConfig("link-product-variant-price-set", linkProductVariantPriceSet);
