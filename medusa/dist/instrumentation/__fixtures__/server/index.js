...
const createServer = async (rootDir) => {
    ...
    await (0, framework_1.featureFlagsLoader)();
    await (0, modules_sdk_1.moduleLoader)({ container: framework_1.container, moduleResolutions, logger: framework_1.logger });
    app.use((req, res, next) => {
        ;
        req.scope = framework_1.container.createScope();
        next();
    });
    await new framework_1.ApiLoader({
        app,
        sourceDir: rootDir,
    }).load();
